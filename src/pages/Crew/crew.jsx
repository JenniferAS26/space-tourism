...
const Crew = () => {
  ...
  return (
    <section className="bg-auto bg-no-repeat bg-center crew-page-container p-4 md:p-8 lg:p-12 absolute w-[1440px] h-[900px] top-[-1927px] left-[101px]">
      <div className="crew-content-wrapper space-y-8 md:space-y-12">
        
        <div className="crew-title">
          <h3 className="font-bellefair title absolute left-[166.5px] top-212 h-34 w-286 gap-2 py-0 pr-1 pl-0 pt-0">
            <span className="title-number">02 </span>
            MEET YOUR CREW
          </h3>
          <img src={backgroundImage} alt="crew" />
        </div>
        <div className="content-douglas flex flex-col md:flex-row items-center md:space-x-8">
          <div className="content-douglas-1 flex flex-col items-start mb-7 md:mb-0">
            <p className="font-bellefair text-light-sky-blue text-3xl uppercase absolute left-165 top-400 h-37 w-214 opacity-50 ">
              COMMANDER
            </p>
          ...
          <div className="crew-content-right relative md:w-1/3 bottom-[-5em] max-h-[40em]">
            <img
              className="w-[568.07px] h-[712px] relative top-[198px] left-[734.93px]"
              src={douglasImage}
              alt="crew"
            />
